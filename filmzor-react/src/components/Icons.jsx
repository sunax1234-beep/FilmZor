...
export function Rewind10Icon({ className = "w-6 h-6" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3 12a9 9 0 1 1 3 6.7" />
      <path d="M3 5v5h5" />
      <text x="7" y="16" fontSize="8" fill="currentColor" stroke="none" fontFamily="sans-serif" fontWeight="700">10</text>
    </svg>
  );
}

export function Forward10Icon({ className = "w-6 h-6" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
